...
class GameBoard(Frame):
    ...
    def __init__(self,root,player1,player2, player3):
        ...
        self.b2 = Button(self.pane, width = 10,text = 'Play Card',command = lambda : self.playCard(self.cardindex))
    ...
    def stats(self, player1, player2, player3):
        ...
        self.text.insert(INSERT, " \nYou are "+ self.player.getName() +" and you are in "+ self.player.getLocation())